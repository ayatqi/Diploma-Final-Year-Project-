...
<head>
	...
	<div class="featured container no-gutter">
		...
		if(isset($_POST["highest"])){
			...
			$product = "SELECT * FROM product WHERE product_type = 3 order by product_Price desc";
			...
			$product = "SELECT * FROM product WHERE product_type = 3 order by product_Price asc";
			$result = $connect->query($product);
			...
			$product = "SELECT * FROM product WHERE product_type = 3";
			$result = $connect->query($product);
