 ...
 <div class="MenuBar">
            ...
            <nav>
                ...
                <ul class="MenuTabs">
                    ...
                    <li class="Sign"><a class="InUp" href="logoutMen_Menu.php">Sign Out</a></li>
        ...
        <div class="Slider">
            ...
            <div class="MySlider fade" style="display: block">
                ...
                <div class="text" style="top: 20%;">
                    ...
                    <h1 style=" font-size:50px; color: #fff; letter-spacing: 5px; font-family: Browallia New;">Men's World.</h1>
                    
                    <button style="background-color: #0f1922; font-size: 18px;"> Shop Now</button>
                </div>
                <img src="Images/Men/Man7.jpg" alt="" width="100%" height="625px">
            ...
            <div class="MySlider fade">
                ...
                <div class="text" style="top: 20%;">
                    <h1 style="font-size: 48px;color: #fff; letter-spacing: 5px; font-family: Browallia New; border-left: 4px solid #463F3A; padding-left: 15px;">Unlock <br><br> Your Styles </h1>
                    
                    <button style="font-size: 18px; margin-top: 15px; display: inline; background-color: #463F3A; color: #F3ECDB;"> Shop Now</button>
                </div>
                <img src="Images/Men/Man5.jpg" alt="" width="100%" height="625px">
            ...
            <div class="MySlider fade">
                ...
                <img src="Images/Men/Man4.jpg" alt="" width="100%" height="625px">
            ...
            <div>
                <div style="margin-left: 80px;">
                    <img src="Images/Men/Man2.jpg" width="100%" height="100%">
                     <a href="Men_Shirt(User).php"><button class="imagebtn" style="font-size: 18px; right: 70.7%;">Shirts</button></a>
                </div>
                <div style="margin-left: 80px; margin-right: 80px; ">
                    <img src="Images/Men/Man10.jpg" width="100%" height="100%">
                     <a href="Men_Accessories(User).php"><button class="imagebtn" style="font-size: 18px; right: 39.5%;">Accessories</button></a>
                </div>
                <div>
                    <img src="Images/Men/Man8.jpg" width="100%" height="100%">
                     <a href="Men_Pants(User).php"><button class="imagebtn" style="font-size: 18px; right: 8.25%;">Pants</button></a>
                </div>
