     ...
     <div class="MenuBar">
            ...
            <nav>
                ...
                <ul class="MenuTabs">
                    ...
                    <li class="Sign" style="left: 40px;"><a class="InUp" href="logoutprocessing.php" style="width:52px; font-size: 13px;">Sign Out</a></li>
        ...
        <div class="Container" style="margin-bottom: 500px;">
            ...
            <div class="Container-text">
					...
					<span class="processing-text">.</span>
					<span class="processing-text">.</span>
					<p>Your Order Has Been Process Successfully !</p>
