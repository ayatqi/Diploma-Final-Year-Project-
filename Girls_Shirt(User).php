...
if(isset($_POST["highest"])){
	 ...
	 $connect = mysqli_connect("localhost","root","","onlineclothingsystem");
			$product = "SELECT * FROM product WHERE product_type = 7 order by product_Price desc";
			...
			if ($result->num_rows > 0) {
				...
				while($row = $result->fetch_assoc()) {
					...
					echo'<a href="product_girldetails.php?product_ID='.$row['product_ID'].'">';
					echo'<div class="featured-item">';
					echo '<img src="Images/Girls/'.$row['product_image'].'" style = "width: 200px; height: 300px;">';
 ...
 $connect = mysqli_connect("localhost","root","","onlineclothingsystem");
			$product = "SELECT * FROM product WHERE product_type = 7 order by product_Price asc";
			$result = $connect->query($product);
		 ...
		 $connect = mysqli_connect("localhost","root","","onlineclothingsystem");
			$product = "SELECT * FROM product WHERE product_type = 7";
			$result = $connect->query($product);
