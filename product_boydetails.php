...
<head>
    ...
    <bod style="background-color:#F4F3EE;"> 
     ...
     <div class="MenuBar">
            ...
            <nav>
                ...
                <ul class="MenuTabs">
                    ...
                    <li class="Sign" style="left: 40px;"><a class="InUp" href="logoutproduct_details.php" style="width:102px; font-size: 13px;">Sign Out</a></li>
          ...
          <div class="col-md-6">
            <div class="product-slider">
              <div id="slider" class="flexslider" style="background-color:#F4F3EE;">
                   ...
                   <?php echo '<img src="Images/Boys/'.$row['product_image'].'" style="width:350px;"/>'; ?>
          ...
          <div class="col-md-6">
            <div class="right-content">
             ...
             <form method="post" action="cart.php?action=add&product_ID=<?php echo $row["product_ID"]; ?>"> 
                ...
                <input type="submit" class="button" name="add_to_cart" value="Add to Cart" style="background-color:#463F3A;">
              </form>
