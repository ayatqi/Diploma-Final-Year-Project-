...
if(isset($_POST["highest"])){
			...
			$product = "SELECT * FROM product WHERE product_type = 5 ORDER BY product_Price desc";
            ...
            $connect = mysqli_connect("localhost","root","","onlineclothingsystem");
			$product = "SELECT * FROM product WHERE product_type = 5 order by product_Price asc";
			$result = $connect->query($product);
            ...
            $connect = mysqli_connect("localhost","root","","onlineclothingsystem");
			$product = "SELECT * FROM product WHERE product_type = 5";
			$result = $connect->query($product);
