        ...
        <div  class="Container-images">
            ...
            <div>
                <div style="margin-left: 80px;">
                    ...
                    <a href="Men_Shirt.php"><button class="imagebtn" style="font-size: 18px; right: 70.7%;">Shirts</button></a>
                </div>
                <div style="margin-left: 80px; margin-right: 80px; ">
                    <img src="Images/Men/Man10.jpg" width="100%" height="100%">
                    <a href="Men_Accessories.php"><button class="imagebtn" style="font-size: 18px; right: 39.5%;">Accessories</button></a>
                </div>
                <div>
                    <img src="Images/Men/Man8.jpg" width="100%" height="100%">
                    <a href="Men_Pants.php"><button class="imagebtn" style="font-size: 18px; right: 8.25%;">Pants</button></a>
                </div>
