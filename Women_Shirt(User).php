...
if(isset($_POST["highest"])){
			...
			$product = "SELECT * FROM product WHERE product_type = 0 order by product_Price desc";
			...
			$product = "SELECT * FROM product WHERE product_type = 0 order by product_Price asc";
			$result = $connect->query($product);
			...
			$product = "SELECT * FROM product WHERE product_type = 0";
			$result = $connect->query($product);
