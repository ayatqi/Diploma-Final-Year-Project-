...
if(isset($_POST["highest"])){
	 ...
	 $connect = mysqli_connect("localhost","root","","onlineclothingsystem");
			$product = "SELECT * FROM product WHERE product_type = 13 order by product_Price desc";
 ...
 $connect = mysqli_connect("localhost","root","","onlineclothingsystem");
			$product = "SELECT * FROM product WHERE product_type = 13 order by product_Price asc";
			$result = $connect->query($product);
	 ...
	 $connect = mysqli_connect("localhost","root","","onlineclothingsystem");
			$product = "SELECT * FROM product WHERE product_type = 13";
			$result = $connect->query($product);
