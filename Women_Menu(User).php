 ...
 <div class="MenuBar">
            ...
            <nav>
                ...
                <ul class="MenuTabs">
                    ...
                    <li class="Sign"><a class="InUp" href="logoutWomen_Menu.php">Sign Out</a></li>
        ...
        <div class="Slider">
            ...
            <div class="MySlider fade" style="display: block">
                ...
                <div class="text" style="top: 20%;">
                    ...
                    <h1 style=" font-size:50px; color: #fff; letter-spacing: 5px; font-family: Browallia New;">Women's World.</h1>
                    
                    <button style="background-color: #E0AFA0; font-size: 18px;"> Shop Now</button>
                </div>
                <img src="Images/Women/Woman7.jpg" alt="" width="100%" height="625px">
            ...
            <div class="MySlider fade">
                ...
                <div class="text" style=" left: 50%;">
                    ...
                    <h1 style="color: #fff; letter-spacing: 5px; font-family: Verdana, sans-serif;">WOMEN'S COLLECTION</h1>
                    
                    <button style="font-size: 18px;"> Shop Now</button>
                </div>
                <img  src="Images/Women/Woman8.jpg" alt="" width="100%" height="625px">
        ...
        <div  class="Container-images">
            ...
            <div>
                <div>
                    <img src="Images/Women/Woman11.jpg" width="100%" height="100%">
                    <a href="Women_Shirt(User).php"><button class="imagebtn" style="font-size: 18px; right:77.05%;">Shirts</button></a>
                </div>
                <div>
                    <img src="Images/Women/Woman12.jpg" width="100%" height="100%">
                    <a href="Women_Accessories(User).php"><button class="imagebtn" style="font-size: 18px; right: 52.15%;">Accessories</button></a>
                </div>
                <div>
                    <img src="Images/Women/Woman10.jpg" width="100%" height="100%">
                    <a href="Women_Pants(User).php"><button class="imagebtn" style="font-size: 18px; right: 27.3%;">Pants</button></a>
                </div>
                <div>
                    <img src="Images/Women/Woman14.jpg" width="100%" height="100%">
                    <a href="Women_Dress(User).php"><button class="imagebtn" style="font-size: 18px; right: 2.55%;">Dresses</button></a>
                </div>
            </div>
        </div>
