        ...
        <div  class="Container-images">
            ...
            <div>
                <div>
                    ...
                    <a href="Girls_Shirt.php"><button class="imagebtn" style="font-size: 18px; right: 77.05%; ">Shirts</button></a>
                </div>
                <div>
                    <img src="Images/Girls/Girl12.jpg" width="100%" height="100%">
                    <a href="Girls_Accessories.php"><button class="imagebtn" style="font-size: 18px; right: 52.15%;">Accessories</button></a>
                </div>
                <div>
                    <img src="Images/Girls/Girl8.jpg" width="100%" height="100%">
                    <a href="Girls_Pants.php"><button class="imagebtn" style="font-size: 18px; right: 27.3%;">Pants</button></a>
                </div>
                <div>
                    <img src="Images/Girls/Girl10.jpg" width="100%" height="100%">
                    <a href="Girls_Pants.php"><button class="imagebtn" style="font-size: 18px; right: 2.55%;">Dresses</button></a>
                </div>
            </div>
        </div>
