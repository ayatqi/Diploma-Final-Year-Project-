     ...
     <div class="MenuBar">
            ...
            <nav>
                ...
                <ul class="MenuTabs">
                    ...
                    <li class="Sign"><a class="InUp" href="logoutBoys_Menu.php">Sign Out</a></li>
        ...
        <div class="Slider">
            ...
            <div class="MySlider fade" style="display: block">
                ...
                <div class="text" style="top: 20%; left:8%;">
                    <p style="font-size: 40px; text-align: center;color: #0f1922; font-family: Lucida Handwriting;">Modern</p>
                    
                    <h1 style=" font-size:50px; color: #fff; letter-spacing: 5px; font-family: Browallia New;">Boys World.</h1>
                    
                    <button style="background-color: #0f1922; font-size: 18px;"> Shop Now</button>
                </div>
                <img src="Images/Boys/Boy4.jpg" alt="" width="100%" height="625px">
            
            </div>
            
            <div class="MySlider fade">
                
                <div class="text" style="top: 35%; left: 60%;">
                ...
                <img src="Images/Boys/Boy8.jpg" alt="" width="100%" height="625px">
            
            </div>
            
            <div class="MySlider fade">
                
                <div class="text" style=" left: 62%; top: 52%;">
                    
                    <p style="font-size: 26px; text-align: center; font-family: Lucida Handwriting;">Trend desgin!</p>
                    
                    <h1 style="color: #fff; letter-spacing: 5px; font-family: Verdana, sans-serif;">BOYS COLLECTION</h1>
                    
                    <button style="font-size: 18px; background-color:#0f1922;"> Shop Now</button>
                </div>
                <img  src="Images/Boys/Boy7.jpg" alt="" width="100%" height="625px">
            
            </div>
            
            <div class="MySlider fade">
                
                <div class="text" style="top: 15%; left: 60%;">
                    ...
                    <p style="font-size: 16px; text-align: center; color: #4064a7; font-family: Luminari; max-width: 400px; ">Like to welcome summer rain, humor may suddenly cleanse and cool the air and you.</p>
                    
                    
                    <button style="font-size: 18px; margin-top: 15px; display: inline; background-color: #1A3263;"> Shop Now</button>
                    
                </div>
                <img src="Images/Boys/Boy6.jpg" alt="" width="100%" height="625px">
        ...
        <div  class="Container-images">
            ...
            <div>
                <div style="margin-left: 80px;">
                    <img src="Images/Boys/Boy5.jpg" width="100%" height="100%">
                    <a href="Boys_Shirt(User).php"><button class="imagebtn" style="font-size: 18px; right: 70.7%;">Shirts</button></a>
                </div>
                <div style="margin-left: 80px; margin-right: 80px; ">
                    <img src="Images/Boys/Boy3.jpg" width="100%" height="100%">
                    <a href="Boys_Accessories(User).php"><button class="imagebtn" style="font-size: 18px; right: 39.5%;">Accessories</button></a>
                </div>
                <div>
                    <img src="Images/Boys/Boy2.jpg" width="100%" height="100%">
                    <a href="Boys_Pants(User).php"><button class="imagebtn" style="font-size: 18px; right: 8.25%;">Pants</button></a>
                </div>
